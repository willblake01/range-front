...
})(["width:100%;height:55px;background-color:", ";opacity:.9;margin:0;padding:5px 20px 5px 20px;display:flex;align-items:center;font-size:1.6rem;a{color:", ";margin-right:5px;margin-left:5px;}a:hover{color:blue;}"], function (props) {
...
})(["background-color:", ";border:none;width:82px;padding:none;"], function (props) {
  return props.theme.darkOrange;
});
...
//# sourceMappingURL=items.js.dc76b2bb64763bd24317.hot-update.js.map