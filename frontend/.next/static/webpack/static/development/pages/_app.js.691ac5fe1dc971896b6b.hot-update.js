...
})([".bar{width:100%;height:480px;border-bottom:10px solid ", ";display:grid;grid-template-columns:auto 1fr;justify-content:space-between;align-items:stretch;background-image:url('https://res.cloudinary.com/willblake01/image/upload/v1538509884/range-front/main_img.png');@media (max-width:1300px){grid-template-columns:1fr;justify-content:center;}}.sub-bar{display:grid;grid-template-columns:1fr auto;border-bottom:1px solid ", ";}#learn{position:relative;top:130px;left:132px;width:180px;height:42px;}"], function (props) {
  return props.theme.green;
}, function (props) {
...
//# sourceMappingURL=_app.js.691ac5fe1dc971896b6b.hot-update.js.map