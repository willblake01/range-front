...
})(["margin-top:110px;.container{max-width:1440px;padding-right:200px;padding-bottom:60px;padding-left:200px;}.header{background-image:url('https://res.cloudinary.com/willblake01/image/upload/v1538509884/range-front/mountain-range.jpg');background-repeat:no-repeat;background-size:cover;height:260px;width:1440px;margin-bottom:20px;}img{width:1040px;margin-bottom:8px;}h1{padding-top:20px;font-weight:bold;}h2{font-weight:bold;}h5{font-weight:bold;}table{font-family:arial,sans-serif;border-collapse:collapse;width:100%;}td,th{border:1px solid #dddddd;text-align:left;padding:8px;}tr:nth-child(even){background-color:#dddddd;}p.boldPara{font-weight:bold;}"]);

var LearnMore = function LearnMore() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(LearnMoreStyle, {
    __source: {
...
//# sourceMappingURL=learnMore.js.475ae701ae0ef3a447dc.hot-update.js.map