...
})(["border-bottom:1px solid ", ";background:", ";padding:1rem;transition:all 0.2s;", ";display:flex;align-items:center;border-left:10px solid ", ";img{max-height:30px;object-fit:contain;margin-right:10px;}"], function (props) {
  return props.theme.lightGrey;
}, function (props) {
...
//# sourceMappingURL=tents.js.6111cea9d84dcc610d5d.hot-update.js.map