...
})(["border-bottom:1px solid ", ";background:", ";padding:1rem;transition:all 0.2s;", ";display:flex;align-items:center;border-left:10px solid ", ";img{max-height:36px;object-fit:contain;margin-right:10px;}"], function (props) {
  return props.theme.lightGrey;
}, function (props) {
...
//# sourceMappingURL=index.js.92fc239de4d7d3687e71.hot-update.js.map