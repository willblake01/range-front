...
})([".shopping-tiles{display:flex;flex-wrap:wrap;background-color:", ";}#shop-tents{width:33.33%;height:480px;min-width:480px;position:relative;text-align:center;color:", ";}#shop-tents:hover{opacity:0.45;}#tents-tile{width:480px;height:480px;opacity:0.34;}#shop-sleepingBags{width:33.33%;height:480px;min-width:480px;position:relative;text-align:center;color:", ";}#shop-sleepingBags:hover{opacity:0.45;}#bags-tile{width:480px;height:480px;opacity:0.36;}#shop-backpacks{width:33.33%;height:480px;min-width:480px;position:relative;text-align:center;color:", ";}#shop-backpacks:hover{opacity:0.45;}#packs-tile{width:480px;height:480px;opacity:0.56;}.centered{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-size:16px;}"], function (props) {
...
//# sourceMappingURL=_app.js.12799f1a20b0fed89e40.hot-update.js.map