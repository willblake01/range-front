...
const AcceptedPayments = () => (
  <StyledAcceptedPayments>
    <div className='accepted-payment'>
      <Image
        src='https://res.cloudinary.com/willblake01/image/upload/v1770303140/range-front/credit_card.webp'
        alt='Credit Card'
        height={251.85}
        width={400}
      />
      <Image
        src='https://res.cloudinary.com/willblake01/image/upload/v1770303428/range-front/bitcoin.webp'
        alt='Credit Card'
        height={280}
        width={280}
      />
